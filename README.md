...
| `settings_screen.dart` | 프로필, 알림 토글 4종(수면/근무/건강/명언), 이동 시간 자유 입력, 데이터 내보내기/가져오기/초기화, 앱 정보 |
...
- **App Store 빌드 실패**: `NSPhotoLibraryUsageDescription` 누락으로 업로드 후 처리 실패하던 문제 수정
